...
def test_git_sync_summary_endpoint():
    ...
    assert "sync_silence_threshold_minutes" in body
    ...
    assert "audit_delivery_health_level" in body
    assert "audit_delivery_health_warning" in body
    assert "audit_delivery_failure_pressure_index" in body
    ...
    assert "audit_delivery_net_density_per_day" in body
    assert "audit_delivery_invalid_density_per_day" in body
    assert "audit_delivery_empty_density_per_day" in body
    assert "audit_delivery_tagged_count" in body
    ...
    assert "last_audit_delivery_empty_at" in body
    assert "minutes_since_last_audit_delivery_empty" in body
    assert "last_audit_delivery_untagged_at" in body
    assert "minutes_since_last_audit_delivery_untagged" in body
    ...
    assert isinstance(body["sync_silence_threshold_minutes"], int)
    ...
    assert body["audit_delivery_health_level"] in {"healthy", "warning", "high_risk"}
    assert isinstance(body["audit_delivery_health_warning"], bool)
    assert isinstance(body["audit_delivery_failure_pressure_index"], float)
    ...
    assert isinstance(body["audit_delivery_net_density_per_day"], float)
    assert isinstance(body["audit_delivery_invalid_density_per_day"], float)
    assert isinstance(body["audit_delivery_empty_density_per_day"], float)
    assert isinstance(body["audit_delivery_tagged_count"], int)
    ...
    assert isinstance(body["last_audit_delivery_empty_at"], str)
    assert isinstance(body["minutes_since_last_audit_delivery_empty"], float)
    assert isinstance(body["last_audit_delivery_untagged_at"], str)
    assert isinstance(body["minutes_since_last_audit_delivery_untagged"], float)
...
def test_analytics_reports_project_execution_and_ops_risk():
    ...
    assert "git_sync_audit_delivery_health_level" in opsb
    assert "git_sync_audit_delivery_health_warning" in opsb
    assert "git_sync_audit_delivery_failure_pressure_index" in opsb
    ...
    assert "git_sync_audit_delivery_net_density_per_day" in opsb
    assert "git_sync_audit_delivery_invalid_density_per_day" in opsb
    assert "git_sync_audit_delivery_empty_density_per_day" in opsb
    assert "git_sync_audit_delivery_tagged_count" in opsb
    ...
    assert "last_git_sync_audit_delivery_empty_at" in opsb
    assert "minutes_since_last_git_sync_audit_delivery_empty" in opsb
    assert "last_git_sync_audit_delivery_untagged_at" in opsb
    assert "minutes_since_last_git_sync_audit_delivery_untagged" in opsb
    ...
    assert "git_sync_event_silence_threshold_minutes" in opsb
    ...
    assert opsb["git_sync_audit_delivery_health_level"] in {"healthy", "warning", "high_risk"}
    assert isinstance(opsb["git_sync_audit_delivery_health_warning"], bool)
    assert isinstance(opsb["git_sync_audit_delivery_failure_pressure_index"], float)
    ...
    assert isinstance(opsb["git_sync_audit_delivery_net_density_per_day"], float)
    assert isinstance(opsb["git_sync_audit_delivery_invalid_density_per_day"], float)
    assert isinstance(opsb["git_sync_audit_delivery_empty_density_per_day"], float)
    assert isinstance(opsb["git_sync_audit_delivery_tagged_count"], int)
    ...
    assert isinstance(opsb["last_git_sync_audit_delivery_empty_at"], str)
    assert isinstance(opsb["minutes_since_last_git_sync_audit_delivery_empty"], float)
    assert isinstance(opsb["last_git_sync_audit_delivery_untagged_at"], str)
    assert isinstance(opsb["minutes_since_last_git_sync_audit_delivery_untagged"], float)
    ...
    assert isinstance(opsb["git_sync_event_silence_threshold_minutes"], int)
